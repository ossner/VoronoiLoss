...
#figure(
  ...
  caption: [Slices of a prediction output of a model trained with $W_"v_iw"$ on a test image of the brain metastases dataset. An annotated metastasis is shown in white with prediction shown in red.
  ],
) <figsbmviwsample>
