...
Using the notation of $K$ Instances $I:{I_0, I_1, dots I_K}$ identified using the connected components method described in @chapter_background the loss function $cal(L)_"blob"$ can be formulated as
