...
#align(center)[
  #table(
    ...
    $hat(I): {hat(I)_1, hat(I)_2, dots, hat(I)_hat(K)}$, [The set of $hat(K)$ connected components (instances) in a prediction.],
    ...
    $W_"v_iw"$, [The Voronoi inverse map assigning a higher value to instances than background @eqviw.],
