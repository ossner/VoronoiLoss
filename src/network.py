...
class InstanceSegmentationModel(pl.LightningModule):
    ...
    def on_test_epoch_end(self):
        ...
        metrics_to_log = {
            ...
            "test/instance/SQDSC_Q1":    mean_quartile_sqdsc['Q1'],
            "test/instance/SQDSC_Q2":    mean_quartile_sqdsc['Q2'],
            "test/instance/SQDSC_Q3":    mean_quartile_sqdsc['Q3'],
            "test/instance/SQDSC_Q4":    mean_quartile_sqdsc['Q4'],
